...
**keepNullVal** | `false` | if the value is `null` then keep the key or property conversion.
**keepOriginVal** | `false` | no matter whate the value was just keep it the same, note when this flag set the `keepNullVal` will be ignored.
