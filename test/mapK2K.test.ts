...
describe("Map Key2Key Test", function () {
    
    describe("ErrDefineClass", function () {
        it("case 0", () => {
            let rtn = mapper.map(ErrDefineClass, {
                a: 1,
                b: "str"
            });
            ...
            assert.strictEqual(rtn.rtn instanceof ErrDefineClass, true);
            assert.strictEqual(Object.keys(rtn.rtn).length, 0);
            assert.strictEqual(Object.values(rtn.rtn).length, 0);
        });
    });
